...
module ADC_DelSig_v3_30_1 (
	...
	cy_clock_v1_0
		#(.id("2daaa0c2-2f5a-4d35-8439-ec01a8c85208/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("2daaa0c2-2f5a-4d35-8439-ec01a8c85208/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
...
module top ;
	...
	wire [0:0] tmpOE__InADC_net;
	wire [0:0] tmpFB_0__InADC_net;
	wire [0:0] tmpIO_0__InADC_net;
	wire [0:0] tmpINTERRUPT_0__InADC_net;
	electrical [0:0] tmpSIOVREF__InADC_net;
	...
	cy_psoc3_pins_v1_10
		...
		InADC
		 (.oe(tmpOE__InADC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__InADC_net[0:0]}),
		  .analog({Net_24}),
		  .io({tmpIO_0__InADC_net[0:0]}),
		  .siovref(tmpSIOVREF__InADC_net),
		  .interrupt({tmpINTERRUPT_0__InADC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__InADC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
